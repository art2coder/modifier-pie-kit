...
카메라 셋업
- 리그 카메라 컬렉션의 체크를 해제하면 해당 카메라가 카메라 선택 폼박스에서 보이지 않도록 개선

배경 이미지
- 다른 카메라가 쓰고 있는 이미지도 함께 삭제되도록 기능 개선
- 파일을 마지막으로 저장할 때 월드 환경 이미지(HDR, EXR)가 자동으로 팩(내장)되는 기능 추가
...
RIG_CAM은 카메라 복사 붙여넣기가 작동하지 않도록 버튼 비활성

카메라 리거 Roll 방향을 카메라 기준으로 변경
